...
## Objective
Wave 18 builder-facing evaluation dashboard with deterministic cross-session quality monitoring and guarded JSON export.

## Scope
- Add deterministic workspace evaluation dashboard aggregation over saved sessions with pass/fail counts and common failure types.
- Surface provenance gaps, stale-source incidence, and claim-linking gaps with template usage summaries.
- Expose builder-facing dashboard and export controls in workspace UI with stable selectors and updated tests.
- Add API endpoints for dashboard retrieval and export gating by aggregate quality cleanliness.

## Metadata
- Generated at (UTC): 2026-04-05T00-56-32Z
- Git SHA: 390dbc1028e93035ac199cfa37af9d4605e4209c
- Git branch: main
- Git dirty: True
- Harness summary: artifacts/harness/2026-04-05T00-55-00Z-wave-18-evaluation-dashboard/summary.json
...
```bash
npm run tsc
npm run vitest -- --reporter=json --outputFile /home/aarav/Aarav/Meridian/artifacts/harness/2026-04-05T00-55-00Z-wave-18-evaluation-dashboard/vitest-report.json
/home/aarav/Aarav/Meridian/.venv/bin/python -m pytest -q --junitxml /home/aarav/Aarav/Meridian/artifacts/harness/2026-04-05T00-55-00Z-wave-18-evaluation-dashboard/pytest-report.xml
npm run playwright -- --reporter=json
Playwright MCP exploratory check: PASS (dashboard readability, quality metrics visibility, deterministic signature, export readiness state).
```
...
- backend_unit: exit=0, passed=63, failed=0, skipped=0, retries=0
- e2e: exit=0, passed=6, failed=0, skipped=0, retries=0
- determinism_signature_sha256: 6ef3c7fea0565eac4764ecd9eb5eeb0553d1b337329bf596090cfbde960b0a1a
...
- test-results/backend_unit.log (327 bytes)
- test-results/e2e.log (14203 bytes)
- test-results/frontend_unit.log (709 bytes)
- test-results/harness-summary.json (2929 bytes)
- test-results/playwright/.last-run.json (45 bytes)
- test-results/playwright/test_methodology-methodology-page-renders/test-finished-1.png (286452 bytes)
- test-results/playwright/test_methodology-methodology-page-renders/trace.zip (642383 bytes)
- test-results/playwright/test_methodology-methodology-page-renders/video.webm (47720 bytes)
- test-results/playwright/test_regime-regime-strip-renders-all-dimensions/test-finished-1.png (41905 bytes)
- test-results/playwright/test_regime-regime-strip-renders-all-dimensions/trace.zip (357288 bytes)
- test-results/playwright/test_regime-regime-strip-renders-all-dimensions/video.webm (56955 bytes)
- test-results/playwright/test_research_flow-research-flow-query-to-complete-brief/test-finished-1.png (84626 bytes)
- test-results/playwright/test_research_flow-research-flow-query-to-complete-brief/trace.zip (4400144 bytes)
- test-results/playwright/test_research_flow-research-flow-query-to-complete-brief/video.webm (464802 bytes)
- test-results/playwright/test_screener-screener-loads-sorts-filters-opens-drawer/test-finished-1.png (199482 bytes)
- test-results/playwright/test_screener-screener-loads-sorts-filters-opens-drawer/trace.zip (791507 bytes)
- test-results/playwright/test_screener-screener-loads-sorts-filters-opens-drawer/video.webm (93377 bytes)
- test-results/playwright/test_smoke-smoke-homepage-chrome-renders/test-finished-1.png (39603 bytes)
- test-results/playwright/test_smoke-smoke-homepage-chrome-renders/trace.zip (446212 bytes)
- test-results/playwright/test_smoke-smoke-homepage-chrome-renders/video.webm (61511 bytes)
- test-results/playwright/test_workspace_persistence-9f535-tegrity-export-and-continue/test-finished-1.png (59150 bytes)
- test-results/playwright/test_workspace_persistence-9f535-tegrity-export-and-continue/trace.zip (7071809 bytes)
- test-results/playwright/test_workspace_persistence-9f535-tegrity-export-and-continue/video.webm (939710 bytes)
...
|---|---|---:|
| README.md | dbcfd66af8d0672609c3e7bc69a605988fdbd7a420e36b6afd18f69658fb9c37 | 413 |
...
| manifest.json | 22de322c10a12b8ff78fcba9fcf372cfc7f71eb6f8d5a5f1be99d11f6ed6078b | 16363 |
...
| test-results/backend_unit.log | 8142add5d6bc75428cab5d762f77383a4292b97ba4a74a6f8b5e3a6536e95ec2 | 327 |
| test-results/e2e.log | 2f899bd3740b07a2a2c140bc5fa42825a2896d871357016d51b26a84b54cc9df | 14203 |
